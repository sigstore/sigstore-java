...
/**
 * Properties about a Certificate Transparency Log. This object stores information about a CT log,
 * its public key, description and URL. It allows verification of SCTs against the log's public key.
 */
public class CTLogInfo {
  ...
  /**
   * Verify the signature of a signed certificate timestamp for the given certificate entry against
