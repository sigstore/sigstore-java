...
public class DigitallySigned {
  ...
  public DigitallySigned(
      HashAlgorithm hashAlgorithm, SignatureAlgorithm signatureAlgorithm, byte[] signature) {
  ...
  /**
   * Get the name of the hash and signature combination. The result can be used to as the argument
