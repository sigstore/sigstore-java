...
public class LegacySigningConfig {
  ...
  static SigstoreSigningConfig from(URI fulcioUrl, URI rekorUrl, URI dexUrl) {
  ...
  public static final SigstoreSigningConfig PUBLIC_GOOD =
      from(FULCIO_PUBLIC_GOOD_URI, REKOR_PUBLIC_GOOD_URI, DEX_PUBLIC_GOOD_URI);
  public static SigstoreSigningConfig STAGING =
      from(FULCIO_STAGING_URI, REKOR_STAGING_URI, DEX_STAGING_GOOD_URI);
}
