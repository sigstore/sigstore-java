...
public class SerializationTest {
  ...
  public void test_decode_SignedCertificateTimestamp() throws Exception {
    ...
    assertEquals(
        DigitallySigned.SignatureAlgorithm.ECDSA, sct.getSignature().getSignatureAlgorithm());
    assertTrue(
        Arrays.equals(new byte[] {0x12, 0x34, 0x56, 0x78}, sct.getSignature().getSignature()));
  ...
  public void test_encode_CertificateEntry_PreCertificate() throws Exception {
    ...
    CertificateEntry entry =
        CertificateEntry.createForPrecertificate(new byte[] {0x12, 0x34, 0x56, 0x78}, new byte[32]);
